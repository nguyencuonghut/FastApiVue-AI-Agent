...
7. Dark/light theme phải đi qua token/class dùng chung.
8. Test framework phải chạy được trong local và Docker test profile.
9. File config phải có `.env.example`, không commit `.env`.
